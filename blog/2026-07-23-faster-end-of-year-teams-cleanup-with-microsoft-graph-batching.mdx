...
My [Somtoday To Microsoft School Data Sync](../docs/tools/apps/somtoday-to-school-data-sync) utility prepares the CSV files that SDS needs. That solves the provisioning side, but it also means I need to finish the SDS lifecycle instead of leaving last year's digital classrooms mixed in with the new ones.
...
- [Somtoday To Microsoft School Data Sync](../docs/tools/apps/somtoday-to-school-data-sync)
