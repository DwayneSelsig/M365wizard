...
## Voeg Purview toe voor informatiebeleid

SharePoint levert de sites, bibliotheken, metadata, versies en machtigingen waarmee documenten worden beheerd. Voeg [Microsoft Purview](../purview.md) toe wanneer informatie ook organisatiebrede classificatie, bescherming, bewaring, records, onderzoek of compliancemaatregelen nodig heeft. Gebruik [Welke Microsoft Purview-oplossing moet je gebruiken?](../../decisions/which-purview-solution-should-you-use.md) om de maatregel te kiezen zonder Purview te behandelen als vervanging voor een duidelijke SharePoint-structuur en duidelijk eigenaarschap.
