...
- [Verbinding maken met Exchange Online PowerShell](https://learn.microsoft.com/nl-nl/powershell/exchange/connect-to-exchange-online-powershell?view=exchange-ps)
- [Get-EXOMailbox](https://learn.microsoft.com/nl-nl/powershell/module/exchangepowershell/get-exomailbox?view=exchange-ps)
- [Aan de slag met de SharePoint Online Management Shell](https://learn.microsoft.com/nl-nl/powershell/sharepoint/sharepoint-online/connect-sharepoint-online)
...
- [Siteverwijdering geblokkeerd door retentie of eDiscovery](https://learn.microsoft.com/nl-nl/troubleshoot/sharepoint/sites/requested-operation-not-supported)
